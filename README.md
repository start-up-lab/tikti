# 🚀 Tikti - L'IA pour les Startups en Algérie
...
Ce dépôt contient la **Landing Page** de Tikti
...
1.  **Cloner le projet** :
    ```bash
    git clone https://github.com/start-up-lab/tikti
    ```
2.  **Lancer le site** : Ouvrez simplement le fichier `index.html` dans votre navigateur préféré.

---

© 2026 Tikti - Landing Page de l'Assistant IA Entrepreneurial.
