# 🚀 ia_start-up_assistant - L'IA pour les Startups en Algérie

> **Assistant stratégique intelligent dédié à l'accompagnement des entrepreneurs algériens.**
> Projet réalisé dans le cadre de l'Innovation Lab — **BIGmama x UMMTO**.
...
- **Intelligence Artificielle** : Architecture basée sur le **RAG (Retrieval-Augmented Generation)** pour garantir des réponses fiables et sourcées.
...
1.  **Cloner le projet** :
    ```bash
    git clone https://github.com/melissarachi-collab/ia_start-up_assistant-
    ```
2.  **Lancer le site** : Ouvrez simplement le fichier `index.html` dans votre navigateur préféré.
